...
export default function InterviewSession() {
  ...
  const [totalQuestions] = useState(initialState.totalQuestions || 20);
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="flex items-center justify-between mb-4">
          <div className="flex items-center gap-3">
            <div className={`w-8 h-8 rounded-lg bg-gradient-to-br ${COMPANY_COLORS[company] || COMPANY_COLORS.general} flex items-center justify-center text-text-primary text-xs font-bold`}>
