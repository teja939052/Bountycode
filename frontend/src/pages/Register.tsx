    ...
    <div className="min-h-screen bg-surface-base flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="w-full max-w-md bg-white rounded-2xl shadow-xl p-6 md:p-8 relative z-10">
        ...
        <form className="space-y-4">
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-4 py-3 border border-gray-200 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all text-gray-900 placeholder-gray-400"
                required
              />
            </div>
          </div>
          ...
          <div>
            ...
            <div className="relative">
              ...
              <input
                ...
                className="w-full pl-10 pr-12 py-3 border border-gray-200 rounded-xl focus:border-green-500 focus:ring-2 focus:ring-green-200 transition-all text-gray-900 placeholder-gray-400"
                required
              />
              <button
                type="button"
            ...
            <div>
              ...
              {isPasswordValid && passwordsMatch ? (
                ...
                <div className="mt-2 flex items-center gap-2 text-sm text-red-500">
                  ...
                  <span>Passwords don't match or are too weak</span>
                </div>
              )}
            </div>
          </div>
          ...
          <button type="button" className="w-full flex items-center justify-center gap-2 border border-gray-200 rounded-xl py-2.5 hover:bg-gray-50 transition-all text-gray-700">
