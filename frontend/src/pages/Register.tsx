...
export default function Register() {
  ...
  const isDisabled = !name || !email || !password || password !== confirmPassword;
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <motion.input
                  ...
                  onFocus={() => setFocusedField && setFocusedField("email")}
            ...
            <div>
              ...
              <div className="relative group">
                ...
                <motion.input
                  ...
                  onFocus={() => setFocusedField && setFocusedField("password")}
                  onBlur={() => setFocusedField && setFocusedField(null)}
