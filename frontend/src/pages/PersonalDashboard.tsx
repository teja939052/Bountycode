      ...
      <div className="max-w-6xl mx-auto space-y-4 sm:space-y-6">
        ...
        <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="flex items-center justify-between">
          ...
          <div className="text-right">
            ...
            <span className="text-xs sm:text-sm font-medium text-text-primary">{user?.name || user?.email || "Coder"}</span>
          </div>
        </motion.div>
          ...
          <div className="relative flex items-center justify-between">
            <div className="flex items-center gap-3 sm:gap-4">
              ...
              <div className="min-w-0">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-text-primary/60 shrink-0">{levelTitle.icon}</span>
                </div>
            ...
            <div className="flex items-center gap-3 sm:gap-6 text-center shrink-0">
              ...
              <div>
                ...
                <div className="text-[10px] sm:text-xs text-text-primary/60">Solved</div>
              </div>
              <div>
                <div className="text-lg sm:text-2xl font-bold">{earnedBadgeCount}/{totalBadges}</div>
                <div className="text-[10px] sm:text-xs text-text-primary/60">Badges</div>
              </div>
            </div>
          </div>
        </motion.div>
