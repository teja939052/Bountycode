  ...
  return (
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-2xl mx-auto">
        <motion.h1
          className="text-3xl font-display font-black text-white mb-8"
        ...
        {activeTab === "billing" && (
          <motion.div
            ...
            animate={{ opacity: 1, x: 0 }}
          >
            <h2 className="text-xl font-display font-bold text-white mb-6">Billing & Plan</h2>
            <div className={`p-4 rounded-lg mb-6 ${isPremium ? "bg-cyber-green/5 border border-cyber-green/20" : "bg-space-panel border border-space-border"}`}>
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="font-bold text-lg capitalize text-white">{user?.plan || "Free"} Plan</p>
