  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-slate-950 text-white">
        <div className="animate-pulse text-indigo-300">Loading referrals...</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-slate-950 text-white px-4 py-8">
      <div className="max-w-4xl mx-auto">
        ...
        <motion.div
          ...
          className="mb-8 bg-gradient-to-r from-indigo-900/40 to-purple-900/40 border border-indigo-500/30 rounded-2xl p-6"
        >
          ...
          {referralData && (
            <>
              <div className="flex items-center gap-3 mb-4">
                <code className="flex-1 break-all rounded-lg bg-slate-800 px-4 py-3 text-sm text-amber-300 font-mono">
                  {referralData.referral_url}
                </code>
                <button
                  onClick={copyCode}
                  className="rounded-lg bg-slate-700 px-4 py-3 text-sm text-slate-200 hover:bg-slate-600"
                >
              ...
              <div className="flex items-center gap-3">
                <button
                  onClick={shareInvite}
                  className="flex-1 rounded-lg bg-indigo-600 px-4 py-2 font-semibold text-white hover:bg-indigo-500 flex items-center justify-center gap-2"
                >
        ...
        <div className="grid grid-cols-2 gap-4 mb-8">
          ...
          >
            ...
            <h3 className="font-bold text-slate-200">You Earn</h3>
            <p className="text-sm text-slate-400">+100 XP + 50 Coins per referral</p>
          </motion.div>
          <motion.div
            className="bg-slate-900/60 border border-slate-800 rounded-xl p-4 text-center"
            whileHover={{ scale: 1.02 }}
          >
            <div className="text-3xl mb-2">🎁</div>
            <h3 className="font-bold text-slate-200">Friend Earns</h3>
            <p className="text-sm text-slate-400">+50 XP + 25 Coins on signup</p>
          </motion.div>
        </div>
        ...
        >
          <div className="flex items-center gap-2 mb-4">
            ...
            <h2 className="text-lg font-bold text-slate-200">Top Referrers</h2>
          </div>
