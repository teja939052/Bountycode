    ...
    <div className="max-w-4xl mx-auto p-6 space-y-6">
      ...
      <div className="flex gap-3">
        <button
          ...
          disabled={loading}
          className="px-4 py-2 bg-amber-500 text-text-primary rounded-lg text-sm font-medium hover:bg-amber-600 disabled:opacity-50"
        >
          🎁 Daily Bonus (+10 🪙)
        </button>
        <button
          onClick={() => setActiveTab("inventory")}
          className={`px-4 py-2 rounded-lg text-sm font-medium ${activeTab === "inventory" ? "bg-indigo-600 text-text-primary" : "bg-surface-card/50 text-brand-primary"}`}
        >
          Inventory ({inventory.length})
        </button>
        <button
          onClick={() => setActiveTab("shop")}
          className={`px-4 py-2 rounded-lg text-sm font-medium ${activeTab === "shop" ? "bg-indigo-600 text-text-primary" : "bg-surface-card/50 text-brand-primary"}`}
        >
          Shop
        </button>
      </div>
              ...
              <div className="flex items-center justify-between">
                ...
                {inventory.includes(itemId) ? (
                  ...
                  <button
                    ...
                    disabled={loading}
                    className="px-3 py-1 bg-indigo-600 text-text-primary rounded-lg text-xs font-medium hover:bg-indigo-700 disabled:opacity-50"
                  >
                    Buy
                  </button>
                )}
