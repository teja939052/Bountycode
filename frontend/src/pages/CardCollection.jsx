...
const RARITY_FILTER_COLORS = {
  all: { active: 'bg-cyber-blue/20 text-cyber-blue border-cyber-blue/40', inactive: 'hover:bg-white/5 text-gray-400' },
  common: { active: 'bg-gray-500/20 text-gray-300 border-gray-500/40', inactive: 'hover:bg-white/5 text-gray-400' },
  uncommon: { active: 'bg-green-500/20 text-green-400 border-green-500/40', inactive: 'hover:bg-white/5 text-gray-400' },
  rare: { active: 'bg-blue-500/20 text-blue-400 border-blue-500/40', inactive: 'hover:bg-white/5 text-gray-400' },
  epic: { active: 'bg-purple-500/20 text-purple-400 border-purple-500/40', inactive: 'hover:bg-white/5 text-gray-400' },
  legendary: { active: 'bg-yellow-500/20 text-yellow-400 border-yellow-500/40', inactive: 'hover:bg-white/5 text-gray-400' },
  mythic: { active: 'bg-pink-500/20 text-pink-400 border-pink-500/40', inactive: 'hover:bg-white/5 text-gray-400' },
};
      ...
      <div className="max-w-6xl mx-auto">
        ...
        {loading ? (
          ...
          >
            ...
            <h3 className="text-lg font-display font-bold text-white mb-2">No Cards Yet</h3>
