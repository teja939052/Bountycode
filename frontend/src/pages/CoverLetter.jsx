  ...
  return (
    <div className="min-h-screen py-12 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        {!resumeId ? (
          <div className="card">
            <h2 className="text-xl font-display font-bold text-white mb-4">Upload Your Resume</h2>
          ...
          <>
            <div className="flex gap-4 mb-6">
              <button
                ...
                className={`flex-1 py-3 rounded-lg font-semibold transition-colors ${
                  activeTab === "cover-letter" ? "bg-cyber-blue text-space-void" : "bg-space-panel border border-space-border text-gray-500"
                }`}
              >
                Cover Letter
              </button>
              <button
                ...
                className={`flex-1 py-3 rounded-lg font-semibold transition-colors ${
                  activeTab === "linkedin" ? "bg-cyber-blue text-space-void" : "bg-space-panel border border-space-border text-gray-500"
                }`}
              >
                LinkedIn About
              </button>
            ...
            {activeTab === "cover-letter" && !coverLetter && (
              <div className="card">
                <h2 className="text-xl font-display font-bold text-white mb-4">Generate Cover Letter</h2>
                <div className="bg-space-void border border-space-border rounded-lg p-3 mb-4">
                  <p className="text-xs font-mono text-gray-400">
                    Resume uploaded: <span className="text-white">{resumeText.substring(0, 80)}...</span>
                  </p>
                </div>
            ...
            {activeTab === "cover-letter" && coverLetter && (
              <div className="card">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-display font-bold text-white">Your Cover Letter</h2>
                  <button
                ...
                <pre className="whitespace-pre-wrap text-xs font-mono text-gray-400 bg-space-void border border-space-border p-4 rounded-lg max-h-[500px] overflow-y-auto">
                  {coverLetter}
                </pre>
            ...
            {activeTab === "linkedin" && !linkedinAbout && (
              <div className="card">
                <h2 className="text-xl font-display font-bold text-white mb-4">Generate LinkedIn About Section</h2>
                <div className="bg-space-void border border-space-border rounded-lg p-3 mb-4">
                  <p className="text-xs font-mono text-gray-400">
                    Resume uploaded: <span className="text-white">{resumeText.substring(0, 80)}...</span>
                  </p>
            ...
            {activeTab === "linkedin" && linkedinAbout && (
              <div className="card">
                <div className="flex items-center justify-between mb-4">
                  <h2 className="text-xl font-display font-bold text-white">Your LinkedIn About Section</h2>
                  <button
                ...
                <pre className="whitespace-pre-wrap text-xs font-mono text-gray-400 bg-space-void border border-space-border p-4 rounded-lg max-h-[300px] overflow-y-auto">
                  {linkedinAbout}
                </pre>
                <div className="flex gap-4 mt-4">
