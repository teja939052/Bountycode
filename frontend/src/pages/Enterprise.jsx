...
export default function Enterprise() {
  ...
  const handleCreate = async (e) => {
    e.preventDefault();
    try {
      await api.createEnterpriseCohort(form.name, form.institution);
        ...
        <motion.div className="mb-8" initial={reduced ? {} : { opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }}>
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-3xl font-bold dark:text-white">Enterprise Portal</h1>
        ...
        <AnimatePresence>
          {showForm && (
            ...
            >
              ...
              >
                <h2 className="text-xl font-bold dark:text-white mb-4">Create Cohort</h2>
            ...
            <div className="md:col-span-1 space-y-3">
              ...
              {cohorts.length === 0 ? (
                ...
                cohorts.map((c) => (
                  ...
                  >
                    <p className="font-semibold text-sm dark:text-white">{c.name}</p>
              ...
              {selected && progress ? (
                <AnimatedCard className="card">
                  <div className="flex items-center justify-between mb-4">
                    <div>
                      <h3 className="font-bold text-lg dark:text-white">{progress.name}</h3>
