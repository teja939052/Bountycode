      ...
      <div className="max-w-4xl mx-auto">
        ...
        {step === "company" && (
          <motion.div initial={reduced ? {} : { opacity: 0 }} animate={{ opacity: 1 }}>
            <h2 className="font-display font-bold text-text-primary mb-6 flex items-center gap-2">
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 rounded-full text-xs font-mono transition-colors ${
                      role === r
                        ...
                        : "bg-space-panel border border-space-border text-gray-400 hover:text-text-primary hover:border-gray-500"
                    }`}
                  >
                    {r}
                  </button>
        ...
        {step === "type" && (
          <motion.div initial={reduced ? {} : { opacity: 0 }} animate={{ opacity: 1 }}>
            ...
            <div className="card mb-6">
              <h3 className="font-display font-bold text-text-primary text-sm mb-4">Interview Mode</h3>
            ...
            <div className="card mb-6 border-cyber-blue/20 bg-cyber-blue/5">
              ...
              <p className="text-xs font-mono text-gray-400">
                ...
                {" "}for <strong className="text-text-primary">{role}</strong> at <strong className="text-text-primary">{difficulty}</strong> difficulty.
