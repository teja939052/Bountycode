...
import { Trophy, Flame, Coins, Star, Zap, Target, Shield, Crown, Calendar, Clock, TrendingUp, Medal, Award, Gem, Rocket, Sword, Anchor, Compass, Map, Eye, EyeOff, ChevronUp, ChevronDown } from 'lucide-react';
    ...
    <div className="min-h-screen py-6 sm:py-8 px-4">
      <div className="max-w-4xl mx-auto">
        ...
        <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mb-6">
          ...
          <StatCard icon={<Sword size={16} />} label="Bosses" value={`${tower.bosses_defeated?.length || 0}/10`} color="text-red-400" />
          <StatCard icon={<Award size={16} />} label="Badges" value={tower.badges?.length || 0} color="text-purple-400" />
          <StatCard icon={<Zap size={16} />} label="Multiplier" value={`${tower.streak_multiplier}x`} color="text-green-400" />
          <StatCard icon={<Crown size={16} />} label="Best Streak" value={tower.longest_streak || 0} color="text-cyber-amber" />
        </div>
