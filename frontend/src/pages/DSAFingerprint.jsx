          ...
          <div className="lg:col-span-1 space-y-4">
            ...
            <Card rarity="rare" hoverEffect={false}>
              ...
              <div className="space-y-2">
                {Object.entries(profile?.skills || {}).filter(([,s]) => s.solved > 0 || s.score > 0).sort(([,a],[,b]) => b.score - a.score).slice(0, 12).map(([topic, skill]) => (
                ...
                {Object.keys(profile?.skills || {}).filter(k => profile.skills[k].solved > 0).length === 0 && (
