      ...
      <div className="flex flex-wrap items-center justify-between gap-3 border-b border-brand-primary/10 bg-gradient-to-r from-white to-brand-gold-pale px-4 py-3">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            onClick={runSamples}
            disabled={running}
            className="inline-flex items-center gap-1.5 rounded-xl bg-brand-secondary px-3 py-2 text-xs font-semibold text-white transition-colors hover:bg-nature-moss disabled:opacity-50"
          >
            <Play size={12} />
            Run
          </button>
          <button
            ...
            disabled={submitting}
            className="inline-flex items-center gap-1.5 rounded-xl bg-brand-primary px-3 py-2 text-xs font-semibold text-white transition-colors hover:opacity-90 disabled:opacity-50"
          >
            <Send size={12} />
            Submit
          </button>
        ...
        <div className="border-t border-brand-primary/10 bg-brand-bg px-4 py-3">
          <div className="flex items-center gap-2">
            <button
              ...
              className={`rounded-full px-3 py-1.5 text-xs font-semibold transition-colors ${mode === "sample" ? "bg-brand-primary text-white" : "bg-white text-brand-muted"}`}
            >
              Samples
            </button>
            <button
              onClick={() => setMode("result")}
              className={`rounded-full px-3 py-1.5 text-xs font-semibold transition-colors ${mode === "result" ? "bg-brand-primary text-white" : "bg-white text-brand-muted"}`}
            >
              Result
            </button>
            <button
              onClick={() => setMode("submissions")}
              className={`rounded-full px-3 py-1.5 text-xs font-semibold transition-colors ${mode === "submissions" ? "bg-brand-primary text-white" : "bg-white text-brand-muted"}`}
            >
              Submissions
            </button>
