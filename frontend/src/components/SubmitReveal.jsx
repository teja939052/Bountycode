        ...
        >
            ...
            {phase >= 2 && (
              ...
              >
                ...
                <div className="flex items-center justify-center gap-3 mb-2">
                  ...
                  <span className="text-xl font-display font-black text-white">{score}/10</span>
                </div>
          ...
          <div className="bg-gray-900/80 border border-gray-700/30 rounded-b-2xl p-4 space-y-4">
            ...
            {phase >= 4 && (
              ...
              >
                <button onClick={onTryAgain} className="flex-1 flex items-center justify-center gap-2 py-2.5 rounded-lg border border-gray-700/40 text-gray-400 hover:text-white hover:border-gray-600 transition-all text-xs font-mono">
                  <RotateCcw size={12} />
                  Try Again
                </button>
                {onNext && (
