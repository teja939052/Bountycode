...
function EmblemShape({ type, colors, rings }) {
  const p = colors.primary;
  const s = colors.secondary;

  switch (type) {
    case 'triquetra':
      return <Triquetra p={p} s={s} rings={rings} />;
    case 'mandala':
      return <Mandala p={p} s={s} rings={rings} />;
    case 'dharma':
      return <DharmaWheel p={p} s={s} rings={rings} />;
    case 'sriYantra':
      return <SriYantra p={p} s={s} rings={rings} />;
    case 'celticKnot':
      return <CelticKnot p={p} s={s} rings={rings} />;
    case 'flowerOfLife':
      return <FlowerOfLife p={p} s={s} rings={rings} />;
    case 'hexagram':
      return <Hexagram p={p} s={s} rings={rings} />;
    case 'spiral':
      return <GoldenSpiral p={p} s={s} rings={rings} />;
    case 'yinYang':
      return <YinYang p={p} s={s} rings={rings} />;
    case 'eye':
      return <AllSeeingEye p={p} s={s} rings={rings} />;
    case 'shield':
      return <Shield p={p} s={s} rings={rings} />;
    case 'compass':
      return <Compass p={p} s={s} rings={rings} />;
    default:
      return <AllSeeingEye p={p} s={s} rings={rings} />;
  }
}
