...
# Find the dynamic world end by looking for the pattern after d-boss
search = '                 _reward(diamonds=40,coins=20,badges=["dp-master"],unlocks_town="town-2-alpine")),\n        ]),\n    ]\n)\n\n# ═══════════════════════════════════════════════════════════════\n# WORLD 12: Alpine Summit (advanced)'

if search in content:
    print('FOUND dynamic close marker')
...
'''
    content = content.replace(search, prefix_town + search)
