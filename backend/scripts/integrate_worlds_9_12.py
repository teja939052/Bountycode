"""Converter: integrate worlds 9-12 into WORLD_REGISTRY.

Converts the higher-level WorldDefinition/TownDefinition/LessonDefinition
models from app.content.worlds_* into the canonical World/Town/Level/Boss
models expected by routes/worlds.py and the frontend.
"""
...
def _lesson_step_to_build(step: Any) -> Build:
    return Build(
        ...
        starter=step.starter or step.starter_code.get("python", "") if isinstance(step.starter_code, dict) else (step.starter or ""),
