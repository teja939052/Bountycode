...
for i in range(500):
    ...
    if topic == "Percentages":
        ...
        q["question"] = "Shop % discount. Discount Rs. Marked price?"
        ...
        q["options"] = [f"{random.randint(1,50)}%" for _ in range(4)]
        ...
        q["options"] = [f"1/{total}", f"1/{fav}", f"{fav}/{total}", f"{total}/{fav}"]
        q["correct_index"] = 0
...
for i in range(200):
    ...
    if topic == "Series":
        ...
        q["question"] = "Series: {} {} {} {} {}".format(*seq)
        q["options"] = [f"{nxt-10}", f"{nxt}", f"{nxt+10}", f"{nxt+20}"
        q["correct_index"] = 1
        ...
        q["options"] = [str(random.randint(6,720)) for _ in range(4)]
        q["correct_index"] = 0
...
for i in range(200):
    ...
    if topic == "Grammar":
        ...
        q["options"] = [f"The team {random.choice(['is','are'])} winning",
                       f"The team {random.choice(['were','are'])} winning",
                       f"The team {random.choice(['was','were'])} winning",
                       f"The team {random.choice(['has been'])} winning"]
        q["correct_index"] = 0
