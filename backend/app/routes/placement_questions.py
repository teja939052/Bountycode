...
try:
    from app.data.placement_aptitude_questions import PLACEMENT_APTITUDE_QUESTIONS_EXTRA
except ImportError:
    PLACEMENT_APTITUDE_QUESTIONS_EXTRA = []

try:
    from app.data.placement_aptitude_questions import PLACEMENT_APTITUDE_QUESTIONS_EXTRA_2
except ImportError:
    PLACEMENT_APTITUDE_QUESTIONS_EXTRA_2 = []

try:
    from app.data.placement_aptitude_questions import PLACEMENT_APTITUDE_QUESTIONS_EXTRA_3
except ImportError:
    PLACEMENT_APTITUDE_QUESTIONS_EXTRA_3 = []

try:
    from app.data.placement_aptitude_questions import PLACEMENT_APTITUDE_QUESTIONS_EXTRA_4
except ImportError:
    PLACEMENT_APTITUDE_QUESTIONS_EXTRA_4 = []

if PLACEMENT_APTITUDE_QUESTIONS_EXTRA:
    PLACEMENT_APTITUDE_QUESTIONS = PLACEMENT_APTITUDE_QUESTIONS + PLACEMENT_APTITUDE_QUESTIONS_EXTRA
if PLACEMENT_APTITUDE_QUESTIONS_EXTRA_2:
    PLACEMENT_APTITUDE_QUESTIONS = PLACEMENT_APTITUDE_QUESTIONS + PLACEMENT_APTITUDE_QUESTIONS_EXTRA_2
if PLACEMENT_APTITUDE_QUESTIONS_EXTRA_3:
    PLACEMENT_APTITUDE_QUESTIONS = PLACEMENT_APTITUDE_QUESTIONS + PLACEMENT_APTITUDE_QUESTIONS_EXTRA_3
if PLACEMENT_APTITUDE_QUESTIONS_EXTRA_4:
    PLACEMENT_APTITUDE_QUESTIONS = PLACEMENT_APTITUDE_QUESTIONS + PLACEMENT_APTITUDE_QUESTIONS_EXTRA_4
