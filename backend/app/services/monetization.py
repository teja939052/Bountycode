...
FREE_TIER = {
    ...
    "features": {
        ...
        "hint_level_3": {"daily": 0, "monthly": 0},
        "company_specific": {"daily": 1, "monthly": 10},
        "star_evaluation": {"daily": 2, "monthly": 20},
        "missing_bullet_generator": {"daily": 0, "monthly": 0},
        "creative_mind": {"daily": 3, "monthly": 30},
    },
...
PRO_TIER = {
    ...
    "features": {
        ...
        "creative_mind": {"daily": -1, "monthly": -1},
    },
    "companies": "all",
}
...
TEAM_TIER = {
    "name": "team",
    "price_per_seat_monthly": 29,
    "price_per_seat_inr": 2499,
    "price_monthly": 145,
    "price_yearly": 1499,
    "min_seats": 5,
    "max_seats": 50,
...
ENTERPRISE_TIER = {
    ...
    "price_monthly": 99,
    "price_yearly": 999,
    "price_inr_monthly": 8299,
    "price_inr_yearly": 82999,
    "features": {
        "resume_bullet_improve": {"daily": -1, "monthly": -1},
        "ats_checklist": {"daily": -1, "monthly": -1},
        "resume_tailor": {"daily": -1, "monthly": -1},
