...
FEATURE_FLAGS: dict[str, dict] = {
    ...
    "battle_pass": {"enabled": True, "description": "Battle pass system"},
    "daily_challenges": {"enabled": True, "description": "Daily adaptive challenges"},
    "mystery_boxes": {"enabled": True, "description": "Mystery box rewards"},
    "power_ups": {"enabled": True, "description": "Power-up shop"},
    "boss_battles": {"enabled": True, "description": "Boss battles at levels 10,20..."},
    ...
    "study_groups": {"enabled": True, "description": "Study groups"},
    "battles": {"enabled": True, "description": "1v1 coding battles"},
    "tournaments": {"enabled": True, "description": "Monthly contests"},
    "scrims": {"enabled": True, "description": "Scrimba-style screencasts"},
    "chat": {"enabled": True, "description": "Real-time chat"},
    "referrals": {"enabled": True, "description": "Referral program"},
    ...
    "world_map": {"enabled": True, "description": "World map exploration"},
    "skill_trees": {"enabled": True, "description": "Visual skill trees"},
    "dungeons": {"enabled": True, "description": "Dungeon challenges"},
    "guilds": {"enabled": True, "description": "Guild system"},
    "economy": {"enabled": True, "description": "Player economy"},
    "seasons": {"enabled": True, "description": "Seasonal events"},
    "game_events": {"enabled": True, "description": "Game events"},
    "card_collection": {"enabled": True, "description": "Card collection"},
    "showcase": {"enabled": True, "description": "Project showcase gallery"},
    "timeline": {"enabled": True, "description": "Placement timeline"},
    ...
    "steam_profile": {"enabled": True, "description": "Steam-style profile"},
    "newspaper": {"enabled": True, "description": "Placement Times newspaper"},
    "lucky_wheel": {"enabled": True, "description": "Daily lucky wheel"},
