...
Not topic chapters. Not lecture → quiz → Diamonds.
    ...
    "competencies": [
        {
            ...
            "steps": [
                ...
                {
                    "type": "real_world",
                    "title": "Real-World: Validate User Signup",
                    "content": "A production signup form receives raw input. Validate name (non-empty), age (18-100), email (must contain @), phone (10 digits). Return {'valid': True} or {'valid': False, 'errors': [...]}.",
                    "function_name": "validate_signup",
                    "signature": "def validate_signup(name, age, email, phone) -> dict:",
                    "description": "Validate a user signup form. Name non-empty, age 18-100, email contains @, phone is 10 digits.",
                    "test_cases": [
                        {"input": ["Alice", 25, "alice@example.com", "9876543210"], "expected": {"valid": True}},
                        {"input": ["", 25, "alice@example.com", "9876543210"], "expected": {"valid": False, "errors": ["invalid name"]}},
                        {"input": ["Bob", 15, "bob@example.com", "9876543210"], "expected": {"valid": False, "errors": ["invalid age"]}},
                    ],
                    "hidden_tests": 5,
                    "diamonds": 40,
                },
        ...
        },
        {
            ...
            "steps": [
                ...
                {
                    "type": "real_world",
                    "title": "Real-World: Build a Log Parser",
                    "content": "Parse a server log line: '2025-01-01 12:00:00 ERROR Database connection failed'. Extract date, time, level, message. Return dict with keys: date, time, level, message.",
                    "function_name": "parse_log",
                    "signature": "def parse_log(line: str) -> dict:",
                    "description": "Parse a log line into structured data. Format: 'YYYY-MM-DD HH:MM:SS LEVEL message'",
                    "test_cases": [
                        {"input": ["2025-01-01 12:00:00 ERROR Database connection failed"], "expected": {"date": "2025-01-01", "time": "12:00:00", "level": "ERROR", "message": "Database connection failed"}},
                    ],
                    "hidden_tests": 4,
                    "diamonds": 40,
                },
        ...
        },
        {
            ...
            "steps": [
                ...
                {
                    "type": "real_world",
                    "title": "Real-World: Parse API Response",
                    "content": "A weather API returns JSON: {'city': 'Mumbai', 'temp_c': 32, 'humidity': 80, 'conditions': {'rain': True, 'wind_kmh': 15}}. Parse and normalize: city title-cased, temp_c as int, humidity as int, conditions.rain as bool. Return normalized dict.",
                    "function_name": "parse_weather",
                    "signature": "def parse_weather(data: dict) -> dict:",
                    "description": "Parse and normalize a weather API response. Handle missing fields with defaults.",
                    "test_cases": [
                        {"input": [{"city": "mumbai", "temp_c": "32", "humidity": 80, "conditions": {"rain": True, "wind_kmh": 15}}], "expected": {"city": "Mumbai", "temp_c": 32, "humidity": 80, "rain": True, "wind_kmh": 15}},
                    ],
                    "hidden_tests": 4,
                    "diamonds": 40,
                },
        ...
        },
        {
            ...
            "steps": [
                ...
                {
                    "type": "real_world",
                    "title": "Real-World: Build a Contact Book CLI",
                    "content": "Build a simple contact book CLI. Functions: add_contact(name, phone), search_contacts(query), list_all(). Store contacts in memory (list of dicts).",
                    "function_name": "contact_book",
                    "signature": "def contact_book(operations: list) -> list:",
                    "description": "Process a list of contact operations. 'add name phone' adds contact, 'search query' returns matching names, 'list' returns all contacts.",
                    "test_cases": [
                        {"input": [["add Alice 9876543210", "add Bob 9876543211", "search Al"]], "expected": [{"name": "Alice", "phone": "9876543210"}, {"name": "Bob", "phone": "9876543211"}]},
                    ],
                    "hidden_tests": 4,
                    "diamonds": 40,
                },
